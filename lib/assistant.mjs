...
export class Assistant {
  ...
  start(id, scope, input) {
    ...
    if (duplicate) return { threadId: id, jobId: this.jobs.get(id)?.id || null, duplicate: true };
    ...
    this.store.append(id, scope, { role: 'user', content: text, images, requestId: input.requestId });
